    ...
    <div>
        ...
        <el-drawer
          ...
          <div class="title">系统设置!</div>
            ...
            <!-- <div class="logout"> -->
              <!-- <div class="theme-title">语料库选择：</div> -->
              <!-- colorPicker组件目前有问题 -->
              <!-- <el-color-picker v-model="themeApi.theme.customTheme" size="small"></el-color-picker> --> 
              <div class="logout">
                <el-button type="primary" round @click="setlang('ind')">印尼语</el-button>
                <el-button type="primary" round @click="setlang('mar')">马来语</el-button>
                <el-button type="primary" round @click="setlang('phi')">菲律宾语</el-button>
                <!-- <span @click="themeApi.setTheme(item)">
                  印尼语
                </span> -->
              </div>          
            <!-- </div>  -->
...
export default {
    setup() {
      ...
      const setlang = (lan) =>{
        ...
        if(lan=='ind') alert('修改语料成功，当前语种为印尼语');
        if(lan=='mar') alert('修改语料成功，当前语种为马来语');
        if(lan=='phi') alert('修改语料成功，当前语种为菲律宾语');
      }
      const logout = () => {
